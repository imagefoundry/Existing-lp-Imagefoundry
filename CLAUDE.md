...
## Project Overview
This is the Image Foundry Labs microsite. Each subdirectory (`adding-people-to-imagery/`, `bringing-people-to-life/`, `dynamic-stills/`) is a standalone page. The root `index.html` is the hub page.
